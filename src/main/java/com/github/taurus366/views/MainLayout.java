...
// Cast MainLayout.class to Class<? extends RouterLayout>
//        configuration.setRoute("camera_list", CameraListView.class, (Class<? extends RouterLayout>) MainLayout.class);
